...
{
    public class CustomerAppService : CrudAppService<Customer, CustomerDto, string, PagedAndSortedResultRequestDto, CreateUpdateCustomerDto, CreateUpdateCustomerDto>,
        ICustomerAppService
    {
