...
{
    public class TerritoryAppService : CrudAppService<Territory, TerritoryDto, string, PagedAndSortedResultRequestDto, CreateUpdateTerritoryDto, CreateUpdateTerritoryDto>,
